...
router.post("/mintnft",async (req,res)=>{
  ...
  res.send(nft.mintnft(req.body.asseturl,req.body.name,req.body.tokenId,req.body.description,req.body.metadata,aa,req.body.walletaddress));
...
router.post("/bot",async (req,res)=>{
  var i=0;
  message.createcollection(req.body.From);
